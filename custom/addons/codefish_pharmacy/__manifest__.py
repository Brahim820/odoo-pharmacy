...

{
    ...
    # for the full list
    'category': 'False',    'summary': 'Codefish Pharmacy ',
    'description': """
...
""",
    ...
    # always loaded
    'data': [
            'views/disease_categories_view.xml',
            'views/disease_view.xml',
            'views/disease_categories_menus.xml',
            'views/res_partner_menus.xml',
            'views/disease_menus.xml',
